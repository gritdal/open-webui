...
async def decision_logs():
    ...
    * `raw` - the full, original decision log event from the enforcer
    ...
    for ev in events:
        ...
        # Compute a human-readable summary when blocked or warned  and sufficient info is available
        summary: Optional[str] = None
        needs_summary = (not final_allow) or (result_str == "warn")
        if needs_summary and phase and evaluated_policy and reasons:
